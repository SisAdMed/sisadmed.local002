            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12 text-xs" id="condi" name="condi">
                ...
                <div class="card-footer">
                    <table id="tbl_saldos_vencidos" class="display responsive nowrap table table-hover table2excel_with_colors" style="width:100%">
                    </table>
                </div>
            </div>
        </form>
