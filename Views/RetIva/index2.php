                    ...
                    <div class="card-header">
                            <div class="row">
                                    ...
                                    <div class="form-group col-sm-2 col-md-2 col-xs-12 center">
                                        <button id="Data" data-id="excel" type="button" class="btn btn-success btn-lg" onclick="report_retiva(this)"><i class="fa-solid fa-file-excel" title="Reporte en Excel"></i></i></button>
                                        <button id="Data" data-id="pdf" type="button" class="btn btn-danger btn-lg" onclick="report_retiva(this)"><i class="fa-solid fa-file-pdf" title="Reporte en PDF"></i></i></button>
                                        <button id="Data" data-id="txt" type="button" class="btn btn-primary btn-lg" onclick="report_retiva(this)"><i class="fa-solid fa-file-text" title="Reporte en TXT"></i></i></button>
                                    </div>
                                    <div class="form-group col-sm-2 col-md-2 col-xs-12">
