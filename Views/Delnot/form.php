<div class="card-body text-xs">
    ...
    <input type="hidden" id="handling_conver" name="handling_conver">
    <input type="hidden" id="tipo_fac" name="tipo_fac" value="N"> 
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4 col-sm-4 col-xs-12 text-xs">
            ...
            <input type="number" name="nro_control" id="nro_control" class="form-control text-xs" readonly>
        </div>
    </div>
    <div class="row">
     ...
     <div class="center text-xs">
        <button type="button" class="btn btn-primary btn-sm text-xs" onclick="agregarDetalleProductos();">+ Agregar Detalle</button>
    </div>
</div>
<?php
    ...
    require_once $_SERVER['DOCUMENT_ROOT'].'/Views/Almacen/modal_Almacenes.php';
