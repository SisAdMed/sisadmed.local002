...
<div class="content-wrapper">
    ...
    <section class="content">
        <form  name="my_form" id="my_form" action="<?php echo base_url ?>/LibVentas/store" method="POST" class="form-horizontal form-label-left" >
            <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                            <div class="row">
                                    ...
                                    <div class="form-group col-sm-2 col-md-2 col-xs-12 center">
                                        <button id="Data" data-id="excel" type="button" class="btn btn-success btn-lg" onclick="fiscal_report('V')"><i class="fa-solid fa-file-excel" title="Reporte en Excel"></i></i></button>
                                        <button id="Data" data-id="pdf" type="button" class="btn btn-danger btn-lg" onclick="fiscal_report(this)"><i class="fa-solid fa-file-pdf" title="Reporte en PDF"></i></i></button>
                                        <button id="Data" data-id="csv" type="button" class="btn btn-primary btn-lg" onclick="fiscal_report(this)"><i class="fa-solid fa-file-csv" title="Reporte en CSV"></i></i></button>
                                    </div>
                                    <div class="form-group col-sm-2 col-md-2 col-xs-12">
