                    ...
                    <div class="card-header">
                            <div class="row">
                                    ...
                                    <div class="form-group col-sm-2 col-md-2 col-xs-12 center">
                                        <button id="Data" data-id="excel" type="button" class="btn btn-success btn-lg" onclick="fiscal_report('C')"><i class="fa-solid fa-file-excel" title="Reporte en Excel"></i></i></button>
