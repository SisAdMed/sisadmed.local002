<div class="card-body">
    ...
    <div class="row">
        <div class="form-group col-md-2 col-sm-2 col-xs-12">
            ...
            <input type="text" name="cod_tmocxc" id="cod_tmocxc" class="form-control text-xs mayusculas" title="Código Tipo de Movimiento" placeholder="Indique el Tipo de Movimiento">
        </div>
        <div class="form-group col-md-6 col-sm-6 col-xs-12">
            <label for="des_tmocxc">Descripción</label>
            <input type="text" name="des_tmocxc" id="des_tmocxc" class="form-control text-xs mayusculas" title="Descripción" placeholder="Indique la Descripción del Tipo de Movimiento">
        </div>
        <div class="form-group col-md-2 col-sm-2 col-xs-12">
            <label for="acc_tmocxc">Acción</label>
            <select name="acc_tmocxc" id="acc_tmocxc" class="form-control text-xs" title="Acción del Tipo de Movimiento"></select>
        </div>
        <div class="form-group col-md-2 col-sm-2 col-xs-12">
            <label for="rec_tmocxc">Relac. de Caja</label>
            <select name="rec_tmocxc" id="rec_tmocxc" class="form-control text-xs" title="Relación de caja"></select>
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-2 col-sm-2 col-xs-12">
            <label for="con_tmocxc">¿Desea conecutivo?</label>
            <select name="con_tmocxc" id="con_tmocxc" class="form-control text-xs"></select>
        </div>
        <div class="form-group col-md-2 col-sm-2 col-xs-12">
            <label for="next_tmocxc">Próximo</label>
            <input type="number" name="next_tmocxc" id="next_tmocxc" class="form-control text-right text-xs">
        </div>
