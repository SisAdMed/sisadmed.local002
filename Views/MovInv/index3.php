                        ...
                        <table id="tabla_grafica_prod" class="display responsive nowrap table table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-right" scope="col">Ventas</th>
                                    <th class="text-right" scope="col">Utilidad</th>
                                    <th class="text-right" scope="col">% Util. Promed.</th>
                                    <th class="text-right" scope="col">Adicional</th>
                                    <th class="text-right" scope="col">Dif.Camb.</th>
                                    <th class="text-right" scope="col">Cuentas por Cobrar</th>
                                    <th class="text-right" scope="col">Monto IVA</th>
                                    <th class="text-right" scope="col">Gastos</th>
                                    <th class="text-right" scope="col">Inventario PPAL</th>
                                    <th class="text-right" scope="col">Inventario Consignado</th>
                                </tr>
                            </thead>
                            <tbody id="tabla_grafica_prod_deta"></tbody>
                        </table>
                    </div>
                </div>
            </div>
