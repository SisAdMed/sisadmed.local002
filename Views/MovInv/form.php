...
<div class="card-body">
    ...
    <div class="tab-content" id="custom-movements-tabcontent">
        <div class="tab-pane fade show active" id="movements-basic" role="tabpanel" aria-labelledby="movements-basic-tab">
            ...
            <div class="row">
                <div class="form-group col-md-2 col-sm-2 col-xs-12">
                    ...
                    <select autofocus class="form-control custom-select rounded-0 text-xs" name="id_tmovinv" id="id_tmovinv"></select>
                </div>
                <div class="form-group col-md-2 col-sm-2 col-xs-12">
                    <label for="num_movinv">Número</label>
                    <input type="text" class="form-control text-right text-xs" name="num_movinv" id="num_movinv" readonly>
                </div>
                  <div class="form-group col-md-2 col-sm-2 col-xs-12">
            ...
            <div class="row">
                <div class="form-group col-md-10 col-sm-10 col-xs-12">
                    ...
                    <textarea id="descrip_movinv" name="descrip_movinv" class="form-control text-xs"></textarea>
                </div>
                <div class="form-group col-md-2 col-sm-2 col-xs-12">
        ...
        <div class="tab-pane fade show" id="movements-detail" role="tabpanel" aria-labelledby="movements-detail-tab">
            ...
            <div class="row">
                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                    <table class="display responsive nowrap table table-hover tblEncaMov" style="width:100%;">
                        <thead>
                            <th>Item</th>
                            <th>Producto</th>
                            <th>Ubicación</th>
