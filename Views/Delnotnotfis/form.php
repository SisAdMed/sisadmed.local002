<div class="card-body text-xs">
    ...
    <input type="hidden" id="tipo_fac" name="tipo_fac" value=<?= $_SESSION['ori'] ?>>
    ...
    <div class="row text-xs">
        <div class="form-group col-md-6 col-sm-6 col-xs-12 text-xs">
            ...
            <select name="id_emp" id="id_emp" class="custom-select rounded-0 text-xs" >
            </select>
        </div>
    ...
    <div class="row text-xs">
        ...
        <div class="form-group col-md-2 col-sm-2 col-xs-12 text-xs">
            ...
            <select name="id_vend" id="id_vend" class="custom-select rounded-0 text-xs" ></select>
        </div>
    ...
    <div class="center text-xs">
        <button type="button" class="btn btn-primary btn-sm text-xs" id="btnAgregarFila" name="btnAgregarFila"> Agregar Detalle</button>
    </div>
</div>
<?php
