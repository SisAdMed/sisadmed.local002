<?php
    ...
    function ChapterBody($file){
        ...
        $cadena = iconv("UTF-8", "ISO-8859-1", $txt);
        //debug($cadena);
        $this->MultiCell(100,3, ($cadena), 0, 'J');
        $this->Ln();
...
for ($i = 0; $i < count($r); $i++) {
    ...
    $pdf->Cell(15, 3, number_format($r[$i]->sub_total / $r[$i]->can_det, 4, ",", "."), 0, 0, 'R');
...
$pdf->PrintChapter(html_entity_decode($GLOBALS['note_fac']) . ' ' . html_entity_decode($GLOBALS['descrip_cot']));
$pdf->PrintTotal();
