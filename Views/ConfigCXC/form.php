		...
		<div class="tab-pane fade show active" id="customer-basic" role="tabpanel" aria-labelledby="customer-basic-tab">
			...
			<div class="row">
				<div class="form-group col-sm-2 col-md-2 col-xs-12">
					...
					<select autofocus name="show_doc" id="show_doc" class="form-control text-xs"></select>
				</div>
				<div class="form-group col-sm-2 col-md-2 col-xs-12">
					<label for="over_charges">¿Permitir cobros en exceso?</label>
					<select name="over_charges" id="over_charges" class="form-control text-xs"></select>
				</div>
				<div class="form-group col-sm-2 col-md-2 col-xs-12">
					<label for="fir_due_date">Madurez Primer vencimiento</label>
					<input autofocus type="number" name="fir_due_date" id="fir_due_date" class="form-control text-right text-xs">
				</div>
				<div class="form-group col-sm-2 col-md-2 col-xs-12">
					<label for="sec_due_date">Madurez Segundo vencimiento</label>
					<input autofocus type="number" name="sec_due_date" id="sec_due_date" class="form-control text-right text-xs">
				</div>
				<div class="form-group col-sm-2 col-md-2 col-xs-12">
					<label for="thi_due_date">Madurez Tercer vencimiento</label>
					<input autofocus type="number" name="thi_due_date" id="thi_due_date" class="form-control text-right text-xs">
				</div>
				<div class="form-group col-sm-2 col-md-2 col-xs-12">
					<label for="fou_due_date">Madurez Cuarto vencimiento</label>
					<input autofocus type="number" name="fou_due_date" id="fou_due_date" class="form-control text-right text-xs">
				</div>
			</div>
			<div class="row">
				<div class="form-group col-sm-2 col-md-2 col-xs-12">
					<label for="cant_dec">Decimales a mostrar en Documentos</label>
					<input autofocus type="number" name="cant_dec" id="cant_dec" class="form-control text-right text-xs">
				</div>
				<div class="form-group col-sm-2 col-md-2 col-xs-12">
