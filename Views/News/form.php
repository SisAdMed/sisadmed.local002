    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="form-group col-sm-2 col-md-2 col-xs-12">
                ...
                <input type="date" class="form-control text-xs" id="fecha_publicacion" name="fecha_publicacion">
            </div>
            <div class="form-group col-sm-4 col-md-4 col-xs-12">
                <label for="titulo">Título</label>
                <input type="text" class="form-control text-xs" id="titulo" name="titulo" placeholder="Ingrese título de la noticia">
            </div>
            <div class="form-group col-sm-6 col-md-6 col-xs-12">
                <label for="url_limpia">URL </label>
                <input type="text" class="form-control text-xs" id="url_limpia" name="url_limpia" placeholder="Ingrese URL limpia" readonly>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-sm-9 col-md-9 col-xs-12 text-center">
                <label for="resumen">Resumen</label>
                <input type="text" class="form-control text-xs" id="resumen" name="resumen" placeholder="Ingrese resumen de la noticia">
            </div>
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="form-group">
                    <label for="contenido">Contenido Completo de la Noticia</label>
