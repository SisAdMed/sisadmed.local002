...
class PDF extends FPDF{
    ...
    function Header(){
        ...
        //Tasa
         if($this->codigo_moneda != $this->moneda_emp){
            $this->Cell(130);
            $this->cell(20, 4, 'Tasa de cambio Bs.: ' . number_format($GLOBALS['tasa_cambio'],4, ",", "."), 0, 1);
        }else{
            $this->Ln(4);
        }
        //Dirección
    ...
    function ChapterBody($file){
        ...
        $this->MultiCell(100,3,$txt.PHP_EOL. $GLOBALS['observa'], 0, 'C');
        $this->Ln();
...
$pdf->PrintChapter($GLOBALS['note_pre']) ;
$pdf->PrintTotal();
