         ...
         <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="customer-products" role="tablist">
               ...
               <?php if ($_SESSION['administrator'] == 1) : ?>
                  ...
                  <li class="nav-item">
                     <a class="nav-link" id="customer-additional-tab" data-toggle="pill" href="#customer-additional" role="tab" aria-controls="customer-additional" aria-selected="true">Adicional</a>
                  </li>
               <?php endif ?>
            </ul>
         </div>
